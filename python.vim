...
" Updated:  2009-10-08
"		Added function call highlighting and misc symbol graying (Jae Kwon)
"			NOTE I haven't really refactored it or documented it well. use at your own risk for now.
"
...
" Function calls (Jae Kwon)
syn match pythonDottedFunc "[a-zA-Z_][a-zA-Z0-9_]* \?(" display contains=pythonDottedParen skipwhite
syn match pythonDottedParen "(" display

syn match pythonCurly "[{|}]" display
syn match pythonSquare "[\[|\]]" display
syn match pythonRound "[(|)]" display
syn match pythonOther "," display
...
if exists("python_highlight_builtins")
  ...
  syn keyword pythonBuiltin	True False bool enumerate frozenset help
  syn keyword pythonBuiltin	reversed sorted sum object
  ...
  syn keyword pythonBuiltin	hasattr hash hex id input int intern
  syn keyword pythonBuiltin	issubclass iter len list locals long map max
  syn keyword pythonBuiltin	min oct open ord pow property range
  syn keyword pythonBuiltin	raw_input reduce reload repr round setattr
  syn keyword pythonBuiltin	slice staticmethod str super tuple unichr
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  hi pythonDottedFunc ctermfg=2
  hi pythonCurly ctermfg=DarkGreen
  hi pythonSquare ctermfg=DarkGreen
  hi pythonRound ctermfg=7
  hi pythonDottedParen ctermfg=7
  hi pythonOther ctermfg=7
  hi pythonSelf ctermfg=7
